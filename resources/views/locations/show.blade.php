    ...
    <div class="row g-4">
        <div class="col-lg-5">
            <div class="card shadow-sm">
                @if ($location->image)
                    <img src="{{ asset('storage/' . $location->image) }}" class="card-img-top location-thumb location-hero" alt="{{ $location->name }}">
                @else
                    <div class="location-thumb-placeholder location-hero"></div>
                @endif
                <div class="card-body">
            ...
            @forelse ($location->reviews as $review)
                <div class="card shadow-sm mb-3">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-2">By {{ $review->user?->name ?? 'Unknown user' }}</p>
                        <p>{{ $review->content }}</p>
