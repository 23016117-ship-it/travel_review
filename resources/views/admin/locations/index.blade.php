...
@section('content')
    <div class="d-flex flex-wrap gap-3 align-items-center justify-content-between mb-4 admin-toolbar">
        ...
        <div class="d-flex flex-wrap gap-2 w-100 w-lg-auto admin-toolbar-actions">
            <form method="GET" action="{{ route('admin.locations.index') }}" class="d-flex flex-wrap gap-2 w-100 w-md-auto">
                ...
                <button type="submit" class="btn btn-primary admin-btn admin-btn-primary">Search</button>
            </form>
            <a href="{{ route('admin.locations.create') }}" class="btn btn-primary admin-btn admin-btn-primary">Add location</a>
        </div>
    </div>
